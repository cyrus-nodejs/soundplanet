...
import {  getNewTracks, } from "../../../../redux/features/audio/audioSlice";
  ...
  return (
    ...
    <NavIndex />
     ...
     <div>
      ...
      <div className="d-inline-flex my-3 fs-4 border-info text-light  border-bottom">New Track</div>
