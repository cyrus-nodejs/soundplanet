import { fetchAdminAllPremiers, getAdminAllPremiers } from "../../redux/features/admin/adminSlice"
...
useEffect(() =>{
    dispatch(fetchAsyncUser())
      ...
      useEffect(() =>{
        dispatch(fetchAdminAllPremiers())
  ...
  return (
    <Row  className='' >
    {allPremiers && allPremiers.length > 0  ? (<div>
      <div>
  <div className="d-inline-flex p-2 fs-4 border-info  border-bottom">All Premier</div>
</div>
    <div  className="row">

{allPremiers?.map((items:USER) =>{
 return (
   <Col  className=" d-flex  flex-column position-relative  mb-3" style={{width:"200px", }}>
