import { fetchAdminAllCustomers, getAdminAllCustomers } from "../../redux/features/admin/adminSlice"
...
useEffect(() =>{
  ...
  return (
    <Row  className='' >
    {allCustomers && allCustomers.length > 0  ? (<div>
      <div>
  <div className="d-inline-flex p-2 fs-4 border-info  border-bottom">All Customers</div>
</div>
    <div  className="row">

{allCustomers?.map((items:USER, id) =>{
 return (
